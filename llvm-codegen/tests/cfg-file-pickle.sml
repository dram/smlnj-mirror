...
(*---------- end pickle-util.in ----------*)
    ...
    fun write_calling_convention (outS, obj) = ASDLFilePickle.writeString (outS, obj)
    fun read_calling_convention inS = ASDLFilePickle.readString inS
    ...
    fun read_c_int inS = (case ASDLFilePickle.readTag8 inS
    ...
    fun write_c_type (outS, obj) = (case obj
           of CTypes.C_void => ASDLFilePickle.writeTag8 (outS, 0w1)
            ...
            | CTypes.C_UNION x0 => (
              ...
              writeSeq write_c_type (outS, x0)))
    fun read_c_type inS = (case ASDLFilePickle.readTag8 inS
...
(*---------- end pickle-util.in ----------*)
    ...
    fun read_fcmpop inS = (case ASDLFilePickle.readTag8 inS
    ...
    fun read_cmpop inS = (case ASDLFilePickle.readTag8 inS
           of 0w1 => CFG_Prim.GT
            | 0w2 => CFG_Prim.GTE
            | 0w3 => CFG_Prim.LT
            | 0w4 => CFG_Prim.LTE
    ...
    fun read_numkind inS = (case ASDLFilePickle.readTag8 inS
           of 0w1 => CFG_Prim.INT
            | 0w2 => CFG_Prim.FLT
            | _ => raise ASDL.DecodeError)
    ...
    fun read_setter inS = (case ASDLFilePickle.readTag8 inS
    ...
    fun read_looker inS = (case ASDLFilePickle.readTag8 inS
    ...
    fun read_pureop inS = (case ASDLFilePickle.readTag8 inS
           of 0w1 => CFG_Prim.ADD
            | 0w2 => CFG_Prim.SUB
            | 0w3 => CFG_Prim.SMUL
            | 0w4 => CFG_Prim.SDIV
    ...
    fun read_arithop inS = (case ASDLFilePickle.readTag8 inS
    ...
    fun read_rounding_mode inS = (case ASDLFilePickle.readTag8 inS
    ...
    fun write_arith (outS, obj) = (case obj
           of CFG_Prim.ARITH{oper, sz} => (
            ...
            | CFG_Prim.REAL_TO_INT{mode, from, to} => (
              ...
              ASDLFilePickle.writeInt (outS, from);
              ASDLFilePickle.writeInt (outS, to)))
    fun read_arith inS = (case ASDLFilePickle.readTag8 inS
           of 0w1 => let
    ...
    fun read_alloc inS = (case ASDLFilePickle.readTag8 inS
           of 0w1 => let
...
(*---------- end pickle-util.in ----------*)
    ...
    fun write_probability (outS, obj) = ASDLFilePickle.writeInt (outS, obj)
    fun read_probability inS = ASDLFilePickle.readInt inS
    fun write_ty (outS, obj) = (case obj
           of CFG.NUMt x0 => (
            ...
            | CFG.FLTt x0 => (
              ASDLFilePickle.writeTag8 (outS, 0w2);
              ASDLFilePickle.writeInt (outS, x0))
            | CFG.PTRt => ASDLFilePickle.writeTag8 (outS, 0w3)
            | CFG.FUNt => ASDLFilePickle.writeTag8 (outS, 0w4)
            | CFG.CNTt => ASDLFilePickle.writeTag8 (outS, 0w5))
    fun read_ty inS = (case ASDLFilePickle.readTag8 inS
           of 0w1 => let val x0 = ASDLFilePickle.readInt inS in CFG.NUMt (x0) end
            | 0w2 => let val x0 = ASDLFilePickle.readInt inS in CFG.FLTt (x0) end
            | 0w3 => CFG.PTRt
            | 0w4 => CFG.FUNt
            | 0w5 => CFG.CNTt
            | _ => raise ASDL.DecodeError)
    ...
    fun write_exp (outS, obj) = (case obj
           of CFG.VAR x0 => (
            ...
            | CFG.OFFSET(x0, x1) => (
              ...
              ASDLFilePickle.writeInt (outS, x0);
              write_exp (outS, x1)))
    fun read_exp inS = (case ASDLFilePickle.readTag8 inS
           of 0w1 => let val x0 = LambdaVarFilePickle.read_lvar inS in CFG.VAR (x0) end
            ...
            | 0w6 => let
              val x0 = ASDLFilePickle.readInt inS
              val x1 = read_exp inS
              in
                  CFG.SELECT (x0, x1)
              end
    ...
    fun write_stm (outS, obj) = (case obj
           of CFG.LET(x0, x1, x2) => (
            ...
            | CFG.RCC{reentrant, linkage, proto, args, results, live, k} => (
              ...
              write_stm (outS, k)))
    fun read_stm inS = (case ASDLFilePickle.readTag8 inS
           of 0w1 => let
              val x0 = read_exp inS
    ...
    fun write_calling_conv (outS, obj) = (case obj
           of CFG.STD_FUN => ASDLFilePickle.writeTag8 (outS, 0w1)
            ...
            | CFG.KNOWN_CHK => ASDLFilePickle.writeTag8 (outS, 0w3)
            | CFG.KNOWN => ASDLFilePickle.writeTag8 (outS, 0w4))
    fun read_calling_conv inS = (case ASDLFilePickle.readTag8 inS
           of 0w1 => CFG.STD_FUN
            | 0w2 => CFG.STD_CONT
            | 0w3 => CFG.KNOWN_CHK
            | 0w4 => CFG.KNOWN
