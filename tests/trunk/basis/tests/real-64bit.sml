...
(* This version of the test is for 64-bit systems, where the default
 * `int` type is larger than the mantissa of a real number.
 *)
...
(* these tests are incorrect when the maxInt is bigger than 2^53
