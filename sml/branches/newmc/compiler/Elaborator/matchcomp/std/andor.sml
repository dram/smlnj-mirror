...
(* makeAndor : pat list * T.ty -> andor * int *)
 ...
 *  return the AND-OR tree and the total count of nodes it contains *)
 ...
 *)
 ...
 in ORinfo.initInfo andOr2; (* record OR-node weights *)
    (andOr2, newId())  (* return the andor tree and the final count of nodes *)
end (* fun makeAndor *)
