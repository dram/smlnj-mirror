...
struct
   ...
   in
    ...
    val print	      = new (flag_cvt, "print", "show all phase IRs", false)
    val printPLambda  = new (flag_cvt, "printPLambda", "show PLambda.lexp", false)
    ...
    val mcdebugging   = new (flag_cvt, "mcdebugging", "MatchComp debugging", false)

    val nmdebugging   = new (flag_cvt, "nmdebugging", "PLambda normalization debugging", false)
    val fcdebugging   = new (flag_cvt, "fcdebugging", "fcontract debugging", false)
    val rcdebugging   = new (flag_cvt, "rcdebugging", "recover debugging", false)
    val spdebugging   = new (flag_cvt, "spdebugging", "specialize debugging", false)
    val wrdebugging   = new (flag_cvt, "wrdebugging", "wrap debugging", false)
    val redebugging   = new (flag_cvt, "redebugging", "reify debugging", false)
    val rtdebugging   = new (flag_cvt, "rtdebugging", "runtime types(?) debugging", false)
