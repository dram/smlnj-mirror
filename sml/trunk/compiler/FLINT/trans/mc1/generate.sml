...
(* genMatch : hrule list * andor * MT.decTree * pvarmap * ruleMap * failInfo * toTcLt * giisTy
	      -> PL.lexp * LV.lvar *)
fun genMatch (andor, decTree, pvarmap, ruleMap, 
			   ...
			   let fun genCase ((con, _, subcase), (con', decTree0)) =
				   ...
				   (if not (conEq (con, con'))  (* verifying ASSERT above *)
					...
					| DCON argNode =>  (* con is non-constant datacon *)
						...
						val mvarenv1 = bindAndorIds (argNode, mvarenv) (* add bindings for argNode *)
						val argMvar = andorMvar (mvarenv1, argNode) (* bound to dcon payload *)
						val baseLexp = genDecTree(decTree0, mvarenv1)
