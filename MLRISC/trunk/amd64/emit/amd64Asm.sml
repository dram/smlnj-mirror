...
(*#line 517.7 "amd64/amd64.mdl"*)
   fun emitInt64 i =
       let
(*#line 518.11 "amd64/amd64.mdl"*)
           val s = Int64.toString i

(*#line 519.11 "amd64/amd64.mdl"*)
           val s = (if (i >= 0)
                  then s
                  else ("-" ^ (String.substring (s, 1, (size s) - 1))))
       in emit s
...
(*#line 583.7 "amd64/amd64.mdl"*)
   fun chop fbinOp =
       let
(*#line 584.15 "amd64/amd64.mdl"*)
           val n = size fbinOp
       in
