 ...
 *)
functor MDTypeUtils(AstPP : MD_PP) : MD_TYPE_UTILS =
struct
   ...
   let val mark = !counter
       ...
       fun arityRaise(bvs, e) =
           ...
           | bvs => let val xs = 
                    ...
                    in  case e of
                          LAMBDAexp cs =>
                           LAMBDAexp(map (fn CLAUSE(cs,e) =>
                                           CLAUSE(TUPLEpat args::cs,e)) cs)
                        | _ => LAMBDAexp[CLAUSE([TUPLEpat args], e)]
                    end
