...
#ifdef RISCos
  /* select on pipes can block forever on riscos. */
	  /* this may be a pipe */
	    return;
#endif RISCos
    ...
    ML_val_t	    arg;
{
	...
	ioWaitFlag = 0;
      ...
      /* There is a pending signal, so restore the ML state to that
       * prior to the callc.
       */
	extern int callc_v[];
    ...
    ML_val_t	    arg;
{
   ...
   * return continuations. */
	...
	MLState->ml_roots[MiscRootMap[i]] = ML_unit;
