...
let
    ...
    val unevaled =  INT(System.Tags.tag_suspension div 2)
    val evaled = INT((System.Tags.tag_suspension+System.Tags.power_tags) div 2)
    ...
    and conv (le, c : value -> cexp) =
     ...
     in FIX([(k,[x],c(VAR x))],
         PRIMOP(P.gethdlr,[],[h],
           [RECORD([(VAR k, OFFp0),(VAR h, OFFp0)],k',
