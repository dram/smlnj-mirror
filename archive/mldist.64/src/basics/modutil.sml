...
fun shiftStamps {is_sign: bool,     (* indicates signature vs functor body *)
    ...
    let (* translations is an association list that maps kind field (of ref type)
	   ...
	   These are used when translating functor bodies, and avoid circularities
	...
	(* lookup and maptyc are not used when translating signatures *)
...
fun shiftSigStamps(toplev : bool, base : stampsets,
