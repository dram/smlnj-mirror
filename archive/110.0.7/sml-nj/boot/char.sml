 ...
 *
 * Revision 1.8  1997/12/02 07:09:59  jhr
 *   Added implementation of String.fromCString, which required implementing
 *   Char.scanC, and exposing that function internally.
 *
 * Revision 1.7  1997/10/08  19:51:48  jhr
 *   Added implementation of Char.fromCString and added support for "\  \"
 *   escape sequence to Char.fromString.
 *
 * Revision 1.6  1997/10/03  13:32:45  jhr
 *   Added missing escape sequences ("\a", "\b", "\v", "\f" and "\r") to
 *   Char.fromString, and added a range check for "\nnn".
 *
 * Revision 1.5  1997/07/31  19:28:01  jhr
 *   Fixed a couple of bugs in the implementation of toCString.
 *
 * Revision 1.4  1997/06/02  19:14:59  jhr
 *   SML'97 Basis Library changes (phase 2)
 *
 * Revision 1.3  1997/05/29  14:44:20  jhr
 *   SML'97 Basis Library changes (phase 1)
 *
 * Revision 1.2  1997/02/11  15:15:40  george
