...
*)
	...
	let val fl = floor(x+0.5)
	    val cl = ceil(x-0.5)
	 in if fl=cl then fl
	    else if Word31.andb(Word31.fromInt fl,0w1) = 0w1 then cl else fl
	end
 ...
 *
 * Revision 1.10.2.1  1999/09/07 17:52:12  dbm
 * fix definition of round
 *
 * Revision 1.10  1997/12/05 06:34:03  george
 *   Fixed minPos to work on architectures with extended precision
 *
 * Revision 1.9  1997/11/20  19:08:36  dbm
 *   Fixed definition of floor, trunc and ceil.
 *
 * Revision 1.8  1997/07/31  19:29:25  jhr
 *   Fixed isNormal bug, and added implementations of real{Floor,Ceil,Trunc}.
 *
 * Revision 1.7  1997/07/18  20:25:44  george
 *   fix for bug 1228
 *
