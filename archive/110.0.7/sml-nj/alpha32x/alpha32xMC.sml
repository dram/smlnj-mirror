...
struct
  ...
  structure F = FlowGraph
	...
	| I.FOPERATEV{oper, fa, fb, fc} => 
	  (case oper
	   of I.ADDT	=> FOperate(0w22, 0wx5a0, fa, fb, fc)
	    | I.SUBT 	=> FOperate(0w22, 0wx5a1, fa, fb, fc)
	    | I.MULT 	=> FOperate(0w22, 0wx5a2, fa, fb, fc)
	    | I.DIVT	=> FOperate(0w22, 0wx5a3, fa, fb, fc)  (* chopped *)
    ...
    fun emitInstr(i,regmap) = 	 emitMCInstr(i,regmap)
  end			      
