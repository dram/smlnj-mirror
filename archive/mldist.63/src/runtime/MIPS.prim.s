 ...
 *
 * $5-$18,20,25 = general purpose pointers (ml_roots[5-18])
 * $21 = internal temp.
 * $24 = arithtemp
 *
...
#define exncont 30
#define atmp1 24
#define atmp2 25	/* NOTE: this is also used by ML code, so it
			  is safe to use in "ML-style" functions that
			  implement the Assembly signature, but it
			 is not safe to use in signal-handling code */
#define atmp3 20	/* ditto */
#define ptrtmp 21
...
set_fsr:
	...
	ori 	$atmp1,$atmp1,0xd00	/* set V, O, and Z bits */
