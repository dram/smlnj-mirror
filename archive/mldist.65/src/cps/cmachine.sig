 ...
 * register cl containing its closure.  It returns a flag that CPSgen
 * will set to the addressing requirement of the function.  Only
 * architectures that need to simulate PC relative addressing require this.
 *)
val beginStdFn : ((EA * EA) -> addressing ref) option
