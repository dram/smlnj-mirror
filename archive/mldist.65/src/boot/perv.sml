...
structure System : SYSTEM =
  struct
	...
	val desc_embedded_real = make_desc(8, tag_embedded_real)
      (* special descriptors *)
	val desc_evaled_susp = make_desc(0, tag_special)
	val desc_unevaled_susp = make_desc(1, tag_special)
...
(* NOTE: this code could be optimized by examining the directory entries incrementally *)
    ...
    open PreLim
    val version = "Standard ML of New Jersey, Version 0.65, 10 September 1990"
