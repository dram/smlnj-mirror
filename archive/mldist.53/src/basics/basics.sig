...
signature BASICS = sig
    ...
    and tyckind
      = ABStyc of tycon (* atomic and abstract types;
			   the tycon is the "hidden" representation *)
      | DEFtyc of tyfun
    ...
    val mkDEFtyc : Symbol.symbol list * tyfun * eqprop * Stampset.stampsets -> tycon
    val mkDATAtyc : Symbol.symbol list * int * datacon list * eqprop * Stampset.stampsets
		     -> tycon
