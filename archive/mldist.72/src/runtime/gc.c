...
#define backptr(x) ((((x)<<width_tags) & (tag_backptr)))
#define get_len(x) (*(int *)(x)>>width_tags)
#define even_len(x) (!(get_len(x)&1))
#define get_lenz(x) ((((*(int*)(x))&mask_tags)==tag_suspension)?1:get_len(x))
