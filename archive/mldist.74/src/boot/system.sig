...
signature UNSAFE =
  sig
    ...
    val load_target_ref : (string -> unit) ref
    val load_source_ref : (string -> unit) ref
    val validTarget_ref : (string -> bool) ref
    val openCompilingEnv_ref : (unit -> unit) ref
    val resetCompilingEnv_ref : (unit -> unit) ref
...
signature COMPILE =
  sig
    ...
    val compileAndLoad :string -> string -> unit
    val loadTarget :string -> unit
    val loadSource :string -> unit
    val validTarget :string -> bool
    val openCompilingEnv :unit -> unit
    val resetCompilingEnv :unit -> unit
  end
