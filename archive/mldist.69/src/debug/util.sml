...
sig
  ...
  val sizing:bool ref  (* True if size reports should be printed. *)
  val sizereport: string -> unit (* Perform and print size report. *)

  val debugEnv: Basics.env ref  
  ...
  (* Encourage a major garbage collection. *)
  ...
  (* Misc. functions *)
  val isFn: Basics.ty -> bool
  val printVal : (System.Unsafe.object * Basics.ty) -> unit
...
struct
  ...
  val debugEnv = ref(Env.empty: Basics.env)
