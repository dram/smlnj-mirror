...
fun hashLabels(labels: Basics.label list) : int =
...
fun mkTUPLEtyc n =
    case TyconArray.sub(tupleTycons,n)
      of NOtycon =>
	       ...
	       val tycon = Basics.RECORDtyc{stamp=hashLabels(labels), labels=labels}
...
fun isTUPLEtyc(Basics.RECORDtyc{labels,...}) =  checklabels(1,labels)
  | isTUPLEtyc _ = false
