...
_openf_v:
	.long	1f
1:	movl	$0666,12(ap)	# do this now because no regs across allocate
	movl	4(sp),r0
	movl	4(r0),r1	# flags
	movl	_flags[r1],8(ap)
	addl3	$4,(r0),4(ap)
...
_floor_v:
	.long 1f
1:
#ifdef V9 /* hack because gfloats aren't implemented in v9's as */
...
.long 0x5104be51
/* bytes should be identical to the followin instructions. */
#ifdef BSD
	movg *4(sp),r0
...
1:	movl	4(sp),r0		# r0 = real*integer
	...
	movl 	$mak_desc(2,tag_string),-4(r12)
	movl	r12,r0
	addl2	$12,r12
	rsb
