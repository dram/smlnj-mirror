...
(*********)
  (* integer operations *)
    ...
    val emit_addcc = threeOp BS.emit_addcc
...
(*** UNTIL CPS BUGS ARE FIXED ***
    ...
    fun emit_addcc (Immed a, Immed b, c) = (
	    warning("emit_addcc", a, b); move(Immed(a+b), c))
    |	emit_addcc args = emit_addcc' args
...
(* DEBUG  val emit_addcc = diag "emit_addcc" emit_addcc *)
