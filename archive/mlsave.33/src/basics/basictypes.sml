...
val boolSym	 = stringToSymbol("bool")
val trueSym	 = stringToSymbol("true")
val falseSym	 = stringToSymbol("false")
val unitSym	 = stringToSymbol("unit")
val listSym	 = stringToSymbol("list")
val consSym	 = stringToSymbol("::")
val nilSym	 = stringToSymbol("nil")
val refSym	 = stringToSymbol("ref")
val intSym	 = stringToSymbol("int")
val realSym	 = stringToSymbol("real")
val stringSym	 = stringToSymbol("string")
val exceptionSym = stringToSymbol("exn")
val contSym	 = stringToSymbol("cont")
val arraySym	 = stringToSymbol("array")
...
val contTycon = ref(mkABStyc([contSym],1,NO))
