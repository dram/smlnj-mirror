...
in
val boot_zero = namedLvar(Symbols.stringToSymbol "boot_zero") (* receives unit *)
val boot_one = namedLvar(Symbols.stringToSymbol "boot_one")   (* traverses free list *)
val boot_two = namedLvar(Symbols.stringToSymbol "boot_two")   (* final bogus arg *)

val (lookLvar, indexerLvar) =
        (saveLvarNames := save;
	 (namedLvar(Symbols.stringToSymbol "lookup"),
	  namedLvar(Symbols.stringToSymbol "indexer"))
	)
end
