functor MipsCM(MipsC : MIPSCODER) : CMACHINE = struct
    ...
    fun store_float(Reg n,ea,offset) = 
        ...
        else (M.swc1(Reg(n+M.low_order_offset),ea,offset+4);
    	  M.swc1(Reg(n+1-M.low_order_offset),ea,offset))
    ...
    fun load_float(Reg dest,src,offset) =
        ...
        else (M.lwc1(Reg(dest+1-M.low_order_offset),src,offset);
              M.lwc1(Reg(dest+M.low_order_offset),src,offset+4))
