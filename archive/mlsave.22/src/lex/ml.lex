...
<S>\\\\		=> (addString "\\"; lex());
<S>\\\"		=> (addString "\""; lex());
<S>\\.		=> (complain "illegal backslash escape"; lex());
<S>\n		=> (complain "unclosed string"; YYBEGIN INITIAL; Token.STRING "");
<S>\\\^[@-_]	=> (addString(chr(ordof(yytext,1)-ord("@"))); lex());
<S>\\\^.	=> (complain "illegal ^ escape"; lex());
<S>\\[0-9]{3}	=>
...
<S>\\[0-9]?	=> (complain "illegal string escape"; lex());
