...
struct
 structure Coder : BASICSPARC = struct
  ...
  (* trap on integer overflow.  The integer overflow code is 0x07 (from
   * "/usr/include/machine/trap.h"). "10__011111101000 0010000000000111" *)
    fun emit_tvs () = (emitWord 36816; emitWord 8199)
