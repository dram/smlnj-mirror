...
(* 8/20/89 (drt) - bug fix: handle functors with empty arguments *)
...
(* bug fix - 8/20/89 (drt) - added if..then..else *)
	    ...
	    case tycon
	      of TYCON _ => tycon (* fixed stamp assumed *)
	       | INDtyc loc => instloc env loc  (* bound tycon *)
...
(* bug fix: drt (8/20/89) - handle functor with empty argument *)
