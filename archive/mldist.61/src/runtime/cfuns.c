    ...
    ML_val_t	    arg;
{
    ...
    if ((! _setjmp (SysCallEnv)) && ((ioWaitFlag = 1), (NumPendingSigs == 0))) {
#ifdef RISCos
    ...
    ML_val_t	    arg;
{
  ...
  /* shed the unecessary stuff */
    callgc0(CAUSE_EXPORT,0x7); callgc0(CAUSE_EXPORT,0x7);
    ...
    int		    level;
{
    ...
    switch (INT_MLtoC(level)) {
      case 0: callgc0 (CAUSE_MINOR,0x7); break;
      default: callgc0 (CAUSE_MAJOR,0x7); break;
    }
