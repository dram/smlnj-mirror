...
#ifdef	CPS
	movl	_handle, d7		/* global excepion handler */
	movl	sp, _bottom		/* marks end of collectible stack data */
	movl	a6@(8),a2		/* function */
	movl	a6@(12),a0		/* argument */
	movl	return_c,d1		/* continuation */
...
Closure(_exportML_v)
	...
	clrl 0		/* invoke the garbage collector */
2:	movl _isexport,d0
	rts
...
Closure(_syscall_v)
	...
	movl	sp@(4),a0 /* ARGS: call#, arglist, argcount */
...
/* From here on used to be M68.math.s */
	...
	.align	2
	.globl	_mathvec
	.long	mak_desc((end_mathvec - _mathvec)/4,tag_record)
_mathvec:
	.long	_exp_e
	.long	_ln_e
	.long	_sqrt_e
