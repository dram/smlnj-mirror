...
open ErrorMsg Basics Lambda Access BasicTyp TypesUtl EqTypes
...
fun equal (concreteType : ty) : lexp =
	...
	fun enter ty =
		...
		val r = ref v
	     in if !System.Control.debugging 
		  then (print "enter: "; PrtType.printType ty; print "\n")
		  else ();
	...
	fun find ty =
	    let fun f ((t,v,e)::r) =
		  ...
		  | f nil = (if !System.Control.debugging
			     ...
			     raise Notfound)
	     in if !System.Control.debugging 
		 then (print "find: "; PrtType.printType ty; print "\n")
		 else ();
		f (!cache)
	    end
	...
	(if !System.Control.debugging
	 then (print "test: "; PrtType.printType ty; print "\n")
	 else ();
	 case ty
