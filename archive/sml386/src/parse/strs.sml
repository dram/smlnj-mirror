...
sig type strArg
    ...
    val makeFCTB:	symbol * functorFormal * (Structure -> Structure option)
...
fun single_formal(name,sign) () =
    (name,sign(2,Stampset.newStampsets()),false)

fun spread_formal (spec_s,err) () =
    (anonParamName,
     Signs.makeSIG (spec_s,err) (true,NULLstr) (3,Stampset.newStampsets()),
     true)
