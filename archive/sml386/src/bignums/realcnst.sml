...
(*
RealCnst: generate ML real constants.
RealCnst uses long multiplication to find the correct bit pattern for
...
functor RealCnst(P : PRIMREAL) : REALCONST =
struct
