...
abstraction HistStor : HISTORYSTORE =
struct

open Weak System.Unsafe DbgUtil DbgKern
...
inlined version follows: *)
	    ((*print " "; print i; print ":";*)
	     case (cast(System.Unsafe.subscript(cast warr,0)),
		   cast(System.Unsafe.subscript(cast warr,~1))) of
	       (a,22) => if (cast ((*unsafe*) subscript(a,0)) = unique0) then
			   ((*print "U0";*)
			    douAl (next,acc))
			 else
			   let val ai' = (*unsafe*) subscript(a,i)
...
inlined version follows: *)
	    (case (cast(System.Unsafe.subscript(cast warr,0)),
		   cast(System.Unsafe.subscript(cast warr,~1))) of
	       (a,22) => let val a0' = (*unsafe*) subscript(a,0)
