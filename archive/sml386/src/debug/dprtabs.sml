...
sig
    ...
    val printExp : BareAbsn.exp * cp2lnf * int * int -> unit
    val printRule : BareAbsn.rule * cp2lnf * int * int -> unit
    val printVB : BareAbsn.vb * cp2lnf * int * int -> unit
    val printRVB : BareAbsn.rvb * cp2lnf * int * int -> unit
    val printDec : BareAbsn.dec * cp2lnf * int * int -> unit
    val printStrexp : BareAbsn.strexp * cp2lnf * int * int -> unit
end

structure DPrtAbs : DPRINTABSYN = struct

open BareAbsn Access Basics PrtUtil PrtType DPrtBas ErrorMsg Tuples
