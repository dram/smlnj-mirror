...
sig
  ...
  *)
  val findVARCONBind: (string list * time * evindex) -> 
                            (time * evindex * (int * Basics.binding))
  ...
  val chaseType: (time * evindex) -> BareAbsyn.exp -> Basics.ty
  val chaseTycon: time -> Basics.tycon -> Basics.tycon
  val chaseStr: time -> Basics.Structure -> Basics.Structure
...
struct
  ...
  open Array List DebugUtil DebugStatic DebugRun 
