...
signature MC = sig
(*	structure Env *)
	val matchCompile : Basics.env -> (BareAbsyn.pat * Lambda.lexp) list * (string->unit) -> Lambda.lexp
	val bindCompile : Basics.env -> (BareAbsyn.pat * Lambda.lexp) list * (string->unit) -> Lambda.lexp
	end
