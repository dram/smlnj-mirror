 ...
 *
 * NOTE: this dies on system errors. We should really recover more gracefully,
 * especially in the case of blast_write.
 */
bulletproofWrite (fd, buf, nbytes)
    int		fd;
    char	*buf;
    int		nbytes;
{
