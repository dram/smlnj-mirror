...
sig
    type cp2lnf
    val printPat : Basics.env -> BareAbsyn.pat * int -> unit
    val printExp : Basics.env -> BareAbsyn.exp * cp2lnf * int * int -> unit
    val printRule : Basics.env -> BareAbsyn.rule * cp2lnf * int * int -> unit
    val printVB : Basics.env -> BareAbsyn.vb * cp2lnf * int * int -> unit
    val printRVB : Basics.env -> BareAbsyn.rvb * cp2lnf * int * int -> unit
    val printDec : Basics.env -> BareAbsyn.dec * cp2lnf * int * int -> unit
    val printStrexp : Basics.env -> BareAbsyn.strexp * cp2lnf * int * int -> unit
end
...
fun printPat env =
  let 
    fun printPat' (_,0) = print "<pat>"
      | printPat' (VARpat v,_) = (print "VARpat("; printVar env v; print ")";())
	...
	(print "RECORDpat{fields=[";
	    ...
	    print "]}")
      | printPat' (CONpat e,_) = (print "CONpat("; printDcon env e; print ")"; ())
      | printPat' (APPpat (e,p), d) = (print "APPpat("; printDcon env e; print ",";
...
and printExp env = 
  let 
    fun printExp'(_,_,_,0) = print "<exp>"
      | printExp'(VARexp(ref var),_,_,_) = (print "VARexp(ref "; printVar env var; print ")")
      | printExp'(CONexp(con),_,_,_) = (print "CONexp("; printDcon env con; print ")")
...
and printRVB env (RVB{var,exp,resultty,...},cp2lnf,ind,d) = 
    (print "RVB{var="; printVar env var; print ",exp="; printExp env (exp,cp2lnf,ind+2,d-1);
    ...
    fun printDec'(_,_,_,0) = print "<dec>"
	  ...
	  (print "STRdec[";
	   printvseq ind ","
		 ...
		 (print "STRB{strvar="; printStrVar strvar; print ",def=";
		    ...
		    case constraint of SOME s => (print "SOME "; printStructure env s)
				     | NONE => print "NONE";
		    print "}"))
	     sbs;
	   print "]")
	  ...
	  (print "ABSdec[";
	   printvseq ind ","
		 ...
		 (print "STRB{strvar="; printStrVar strvar; print ",def=";
		    printStrexp env (def,cp2lnf,ind+4,d-1); print ",thin,constraint=";
		    case constraint of SOME s => (print "SOME "; 
						 printStructure env s)
				     | NONE => print "NONE";
		    print "}"))
	     sbs;
	   print "]")
	 ...
	 (print "SIGdec[";
	  ...
	  (print "OVLDdec["; printVar env ovldvar; print "]")
