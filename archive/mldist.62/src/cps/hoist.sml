	   ...
	   (case hoist e
	    of (e as FIX'(l,v1,e',v2), v3) => 
		    if member v1 w orelse not(!CG.hoistup)
		      then (RECORD'(vl, w, e, v3), v3--[w]\/uniqv(map #1 vl))
		      else let val defined = uniq(map #1 l)
			       val v4 = v2--[w]\/uniqv(map #1 vl)
			    in (FIX'(l,v1,RECORD'(vl,w,e',v2),v4), v1\/(v4--defined))
			   end
	    | (e,v1) => (RECORD'(vl, w, e, v1), v1--[w]\/uniqv(map #1 vl)))
	 | SELECT(i,v,w,e) =>
	   (case hoist e of
	      (e as FIX'(l,v1,e',v2), v3) => if member v1 w orelse not(!CG.hoistup)
		      then (SELECT'(i, v, w, e, v3), v3--[w]\/uniqv[v])
		      else let val defined = uniq(map #1 l)
			       val v4 = v2--[w]\/uniqv[v]
			    in (FIX'(l,v1,SELECT'(i,v,w,e',v2),v4),v1\/(v4--defined))
			   end
	    | (e,v1) => (SELECT'(i, v, w, e, v1),v1--[w]\/uniqv[v]))
	 | PRIMOP(i,vl,wl,[e]) =>
	   (case hoist e
	     of(e as FIX'(l,v1,e',v2),v3) =>
	      (case (uniq wl /\ v1, !CG.hoistup)
	        of ([],true) => let val v4 = v2--uniq wl\/uniqv vl
		             val defined = uniq(map #1 l)
			  in (FIX'(l,v1,PRIMOP'(i,vl,wl,[(e',v2)]),v4),v1\/(v4--defined))
			 end
	         | _  =>  (PRIMOP'(i, vl, wl, [(e,v3)]),v3--uniq wl\/uniqv vl))
	    | (e,v1) => (PRIMOP'(i, vl, wl, [(e,v1)]),v1--uniq wl\/uniqv vl))
	 | PRIMOP(i,vl,wl,el) => 
