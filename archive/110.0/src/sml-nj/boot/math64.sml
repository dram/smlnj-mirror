 ...
 *
 * Revision 1.5  1997/11/20 19:07:12  dbm
 *   Changed name of isNaN to isNan, fixed definition of floor and atan.
 *
 * Revision 1.4  1997/11/12  19:21:18  jhr
 *   Fixed bug with Math.ln(0.0) not returning ~inf.
 *
 * Revision 1.3  1997/08/21  09:01:57  george
 *   Fixed bugs in sqrt and ln over subnormal numbers.   -- appel
 *
