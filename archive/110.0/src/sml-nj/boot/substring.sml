 ...
 *
 * Revision 1.6  1997/11/19 17:38:22  jhr
 *   Changes to make sure that Overflow doesn't occur when checking for
 *   an out of bound index.
 *
 * Revision 1.5  1997/11/12  14:51:57  jhr
 *   Fixed type of Substring.slice to agree with the Basis spec.
 *
 * Revision 1.4  1997/10/23  15:34:50  jhr
 *   Added missing basis function (Substring.extract).
 *
 * Revision 1.3  1997/06/02  19:15:05  jhr
 *   SML'97 Basis Library changes (phase 2)
 *
 * Revision 1.2  1997/01/31  20:39:44  jhr
