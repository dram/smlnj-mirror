 ...
 *
 * Socket implementation for win32 (winsock)
 *)
...
(** Should do some range checking on backLog *)
	...
	(* raise Fail "poll descriptors not implemented for Sockets" *)
        (* Option.valOf(OS.IO.pollDesc(PreOS.IO.IODesc fd)) *)
	Option.valOf (OS.IO.pollDesc (PreOS.IO.SockDesc fd))
...
(*
 * $Log: win32-socket.sml,v $
 * Revision 1.1.1.1  1999/12/03 19:59:42  dbm
 * Import of 110.0.6 src
 *
 * Revision 1.1.2.1  1999/06/29 18:22:52  riccardo
 * Winsock support
 *
