 ...
 *
 * Revision 1.7  1997/10/08  20:41:42  jhr
 *   Fixed bug in String.substring --- raised Overflow instead of Subscript
 *   for some arguments.
 *
 * Revision 1.6  1997/07/07  18:06:34  jhr
 *   Added extract function to String (moved the implementation from CharVector).
 *
 * Revision 1.5  1997/06/02  19:15:04  jhr
 *   SML'97 Basis Library changes (phase 2)
 *
 * Revision 1.4  1997/05/29  14:44:28  jhr
 *   SML'97 Basis Library changes (phase 1)
 *
 * Revision 1.3  1997/03/19  20:08:50  george
 *   bugfix for 1108 -- String.maxSize missnamed as String.maxLen
 *
 * Revision 1.2  1997/02/11  15:15:48  george
