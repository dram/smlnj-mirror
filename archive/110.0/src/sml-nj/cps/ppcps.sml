...
signature PPCPS =
sig 
  val printcps : (CPS.function * LambdaType.lty Intmap.intmap) -> unit
...
exception NULLTABLE
val nulltable : LambdaType.lty Intmap.intmap= Intmap.new(8,NULLTABLE)
