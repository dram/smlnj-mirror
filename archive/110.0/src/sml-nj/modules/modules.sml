...
datatype Signature
  = SIG of {name : S.symbol option,
	    closed : bool,
            ...
            boundeps : (EP.entPath * LK.tkind) list option ref,
            lambdaty : (LK.lty * DI.depth) option ref,
...
and tycExp (* expression evaluating to a TYCentity *)
  ...
  | FMGENtyc of Types.tycon * EP.entVar option    (* formal datatyc *)
  | FMDEFtyc of Types.tycon                       (* formal deftyc *)

(* formal tycon to be instantiated *)
