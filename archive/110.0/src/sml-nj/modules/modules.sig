...
datatype Signature
  = SIG of {name : Symbol.symbol option,
	    closed : bool,
            ...
            boundeps : (EntPath.entPath * LtyKernel.tkind) list option ref,
            lambdaty : (LtyKernel.lty * DebIndex.depth) option ref,
...
and tycExp (* expression evaluating to a TYCentity *)
  ...
  | FMGENtyc of Types.tycon * EntPath.entVar option   (* formal datatyc *)
