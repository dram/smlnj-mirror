...
structure SCStaticEnv : SCSTATICENV = struct
	...
	val SC = Stats.doPhase (Stats.makePhase "Compiler 038 1-SCStatenv") SC

	fun consolidate (e, _) = SC (SE.consolidate e)
    end (* local *)
end (* structure SCStaticEnv *)
 ...
 *
 * Revision 1.7  1997/09/30 02:26:05  dbm
 *   Added case for Modules.ERReenv.
 *
 * Revision 1.6  1997/09/17  21:29:29  dbm
 *   New symbol parameter of STRdec.
 *
 * Revision 1.5  1997/08/11  18:25:14  george
 *   For layering I just concatenate lists of modmaps.  This is ok, because
 *   with CM these lists never become very long.  It avoids potentially
 *   expensive merging operations for binary dictionaries, though.
 *   Unpickling performance seems almost unchanged despite the less
 *   efficient representation of modmaps for the purpose of lookup.
 *                                                            -- blume
 *
 * Revision 1.4  1997/04/02  04:03:39  dbm
 *   Added CONSTRAINstr case to function strExp.  Associated with fix of
 *   bug 12.
 *
 * Revision 1.3  1997/02/28  21:58:33  dbm
 * Fix for -elab booting problem.  Replaced definition of expSC. (Zhong)
 *
 * Revision 1.2  1997/02/26  21:50:41  george
