...
* `numsaved` is the number of saved literals (used for sharing)

Note that Version 1 files will have the version ID `0x19981022` and have
a different header layout encoding.
...
* `00010011` (`0x13` *n* *d~1~* ... d~|n|~) <br />
    **BIGINT**(*i*) --- where *i* = **sign**(*n*) 10^|n|-1^ d~|n|~ ... d~1~.
    *I.e.*, the absolute value of *n* is the number of digits, where is *n* is
    ...
    to most-significant order.  If *n* is zero, the *i* is zero.

* `00010100` (`0x14` *ub* *b~1~* ... *b~ub~*) <br />
    **IVEC8**(*ub*, *b~1~*, ..., *b~ub~*) --- short bytevectors (up to 255 elements).

* `00010101` (`0x15` *n* *b~1~* ... *b~n~*) <br />
    **IVEC8**(*n*, *b~1~*, ..., *b~n~*)

* `00010110` (`0x16` *ub* *h~1~* ... *h~ub~*) <br />
    **IVEC16**(*ub*, *h~1~*, ..., *h~ub~*) --- short 16-bit integer vectors (up to 255 elements).

* `00010111` (`0x17` *n* *h~1~* ... *h~n~*) <br />
    **IVEC16**(*n*, *h~1~*, ..., *h~n~*)

* `00011000` (`0x18` *ub* *w~1~* ... *w~ub~*) <br />
    **IVEC32**(*ub*, *w~1~*, ..., *w~ub~*) --- short 32-bit integer vectors (up to 255 elements).

* `00011001` (`0x19` *n* *w~1~* ... *w~n~*) <br />
    **IVEC32**(*n*, *w~1~*, ..., *w~n~*)

* `00011010` (`0x1A` *ub* *lw~1~* ... *lw~ub~*) <br />
    **IVEC64**(*ub*, *lw~1~*, ..., *lw~ub~*) --- short 64-bit integer vectors (up to 255 elements).

* `00011011` (`0x1B` *n* *lw~1~* ... *lw~n~*) <br />
    **IVEC64**(*n*, *lw~1~*, ..., *lw~n~*)
...
* `00110101` -- `11111110` (`0x35` -- `0xFE`) <br />
    *unused*

* `11111111` (`0xFF`) `RETURN` <br />
