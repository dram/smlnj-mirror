...
Example:
  ...
  fun f (A(A(L x, L y)|B(L x, L y)), B(A(L y, L x)|B(L x, L y))) = x + y;

4 versions of the variable pair (x,y), at "decision" paths A.A, A.B, B.A, B.B.
(1) x @ <0.A.A.0.L>, y @ <0.A.A.1.L>
(2) x @ <0.A.B.0.L>, y @ <0.A.B.1.L>
(2) x @ <1.B.A.1.L>, y @ <1.B.A.0.L>
(4) x @ <1.B.B.0.L>, y @ <1.B.B.1.L>
...
[<>] AND v28 {0} {}
   [<0>] OR v29 {0} {}
      ...
      [<0.A>] OR v30 {0} {}
         ...
         [<0.A.B>] AND v31 {0} {}
            [<0.A.B.0>] OR v32 {0} {}
               L [<0.A.B.0.L>] VARS v33 (x,0) {0}
            [<0.A.B.1>] OR v34 {0} {}
               L [<0.A.B.1.L>] VARS v35 (y,0) {0}
         A
         [<0.A.A>] AND v36 {0} {}
            [<0.A.A.0>] OR v37 {0} {}
               L [<0.A.A.0.L>] VARS v38 (x,0) {0}
            [<0.A.A.1>] OR v39 {0} {}
               L [<0.A.A.1.L>] VARS v40 (y,0) {0}
   [<1>] OR v41 {0} {}
      B
      [<1.B>] OR v42 {0} {}
         B
         [<1.B.B>] AND v43 {0} {}
            [<1.B.B.0>] OR v44 {0} {}
               L [<1.B.B.0.L>] VARS v45 (x,0) {0}
            [<1.B.B.1>] OR v46 {0} {}
               L [<1.B.B.1.L>] VARS v47 (y,0) {0}
         A
         [<1.B.A>] AND v48 {0} {}
            [<1.B.A.0>] OR v49 {0} {}
               L [<1.B.A.0.L>] VARS v50 (y,0) {0}
            [<1.B.A.1>] OR v51 {0} {}
               L [<1.B.A.1.L>] VARS v52 (x,0) {0}
dectree:
CHOICE [<0>]
  A
  CHOICE [<1>]
