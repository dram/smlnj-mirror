...
== New Files (in base/compiler/Elaborator/matchcomp)
   ...
   dec-tree.sml -- constructing a decision tree from andor tree,
   		   decision trees involve only OR nodes
   mccode.sml   -- constructing "abstract" match compiler code (mcexp)
...
================================================================================
email to Bob, 2020.5.31 - high level overview of the new match compiler
================================================================================
