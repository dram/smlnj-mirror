...
fun yyAction9 (strm, lastMatch : yymatch) = (yystrm := strm;   T.KW_true )
fun yyAction10 (strm, lastMatch : yymatch) = (yystrm := strm;   T.KW_false )
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3A
              ...
              then if inp = 0wx2F
                  ...
                  else yyQ35(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
            else if inp = 0wx46
              then yyAction12(strm, yyNO_MATCH)
            else if inp < 0wx46
              then if inp = 0wx45
            ...
            if inp = 0wx46
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx30
                      ...
                      then yyQ45(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
                      else yyQ53(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
                else if inp = 0wx45
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3C
              ...
              then if inp = 0wx2A
                  ...
                  then yyAction17(strm, yyNO_MATCH)
                  else yyQ53(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp = 0wx61
              then yyQ45(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp < 0wx61
              then if inp = 0wx5D
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx6E
              ...
              then if inp = 0wx62
                  then yyQ6(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                else if inp < 0wx62
                  then if inp = 0wx22
                      then yyQ5(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                      else yyAction18(strm, yyNO_MATCH)
                else if inp = 0wx66
                  then yyQ7(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                  else yyAction18(strm, yyNO_MATCH)
            else if inp = 0wx74
