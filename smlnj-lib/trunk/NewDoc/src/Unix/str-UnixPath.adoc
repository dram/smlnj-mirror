...
link:../Util/str-PathUtil.html[`PathUtil`] module
in the link:../Util/smlnj-lib.html[*Util Library*].
...
link:str-UnixEnv.html[`UnixEnv`],
link:unix-lib.html[__The Unix Library__]
